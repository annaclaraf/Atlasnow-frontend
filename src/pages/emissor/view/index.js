                                ...
                                return (
                                    <tbody key={emissor.id}>
                                        <tr className="direita">
                                            <td>{emissor.nome}</td>
                                            <td>{emissor.CPF}</td>
                                            <td>{format(new Date(emissor.dataAdmissao), 'dd-MM-yyyy')}</td>
                                            <td>{
                                                emissor.dataFimAdmissao ? format(new Date(emissor.dataFimAdmissao), 'dd-MM-yyyy') : null
                                            }</td>
