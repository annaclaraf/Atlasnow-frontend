    ...
    return (
        <main>
            ...
            <section className="cadastro">
                                ...
                                <div className="align-2">
                                    <div className="dataAdmissao">
                                        ...
                                        <input
                                            ...
                                            type="date"
                                            value={
                                                dataAdmissao ? dataAdmissao : format(new Date(emissor.dataAdmissao), 'yyyy-MM-dd')
                                            }
                                    ...
                                    <div className="dataFimAdmissao">
                                        ...
                                        <input
                                            ...
                                            type="date"
                                            value={
                                                dataFimAdmissao ? dataFimAdmissao : emissor.dataFimAdmissao ?
                                                    format(new Date(emissor.dataFimAdmissao), 'yyyy-MM-dd') : dataFimAdmissao
                                            }
                ...
                <footer>
                    <button className="button" onClick={paginaEmissor}>
                        Voltar
                    </button>
                </footer>
            </section>
