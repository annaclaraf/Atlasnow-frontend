        ...
        <div className="inicial">
            <nav id="navigation">
                <div className="wrapper">
                    <a className="logo" onClick={closeMenu}> </a>
                    <svg
                        width="202"
                        height="64"
                        viewBox="0 0 202 64"
                    ...
                    <div className="menu">
                        <ul>
                            <li><a onClick={closeMenu} href="#services">Vantagens</a></li>
                ...
                <div className="wrapper">
                    <div className="coluna-a">
                        ...
                        <div className="content">
                            ...
                            <p>
                                A Ata é uma forma criada pelas organizações para registrar acontecimentos e assuntos tratados durante uma reunião. Atas podem conter formalidades e normas de produção, redação técnica e pode servir como registro legal. Nos dias atuais, em Corporações privadas a principal característica da Ata é registrar decisões e acompanhar a execução das mesmas, cada vez com menos formalidades.
                            </p>
                    ...
                    <div className="content">
                        <div className="cards">
                            <div className="card">
                                ...
                                <h3>Armazenagem</h3>
                                <p>
                                    Elimine arquivos, pastas e pilhas de papéis desnecessários. Economize espaço físico em sua empresa. Encontre facilmente as ATAS por data, assunto ou por departamento. Tenha maior segurança e muito mais organização.
                                </p>
                            </div>
                            <div className="card">
                                <svg xmlns="http://www.w3.org/2000/svg" height="48" width="48"><path d="M8 38V35H12.2V19.7Q12.2 15.6 14.675 12.275Q17.15 8.95 21.2 8.1V6.65Q21.2 5.5 22.025 4.75Q22.85 4 24 4Q25.15 4 25.975 4.75Q26.8 5.5 26.8 6.65V8.1Q30.85 8.95 33.35 12.275Q35.85 15.6 35.85 19.7V35H40V38ZM24 23.25Q24 23.25 24 23.25Q24 23.25 24 23.25Q24 23.25 24 23.25Q24 23.25 24 23.25ZM24 44Q22.4 44 21.2 42.825Q20 41.65 20 40H28Q28 41.65 26.825 42.825Q25.65 44 24 44ZM15.2 35H32.85V19.7Q32.85 15.95 30.325 13.375Q27.8 10.8 24.05 10.8Q20.35 10.8 17.775 13.375Q15.2 15.95 15.2 19.7Z" /></svg>
                                <h3>Notificações</h3>
                                <p>
                                    Possibilidade de uso de diversos tipos de notificações. Receba cópias das atas por email. Envie tarefas por email direto ao responsável. Receba notificações de prazos vencidos. Notifique terceiros responsáveis.
                                </p>
                            </div>
                            <div className="card">
                                <svg xmlns="http://www.w3.org/2000/svg" height="48" width="48"><path d="M18 5V2H30V5ZM22.5 27.35H25.5V15.85H22.5ZM24 43.95Q20.3 43.95 17.025 42.525Q13.75 41.1 11.3 38.65Q8.85 36.2 7.425 32.925Q6 29.65 6 25.95Q6 22.25 7.425 18.975Q8.85 15.7 11.3 13.25Q13.75 10.8 17.025 9.375Q20.3 7.95 24 7.95Q27.35 7.95 30.3 9.075Q33.25 10.2 35.55 12.2L38.1 9.65L40.2 11.75L37.65 14.3Q39.45 16.3 40.725 19.15Q42 22 42 25.95Q42 29.65 40.575 32.925Q39.15 36.2 36.7 38.65Q34.25 41.1 30.975 42.525Q27.7 43.95 24 43.95ZM24 40.95Q30.25 40.95 34.625 36.575Q39 32.2 39 25.95Q39 19.7 34.625 15.325Q30.25 10.95 24 10.95Q17.75 10.95 13.375 15.325Q9 19.7 9 25.95Q9 32.2 13.375 36.575Q17.75 40.95 24 40.95ZM24 26Q24 26 24 26Q24 26 24 26Q24 26 24 26Q24 26 24 26Q24 26 24 26Q24 26 24 26Q24 26 24 26Q24 26 24 26Z" /></svg>
                                <h3>Tempo</h3>
                                <p>
                                    Faça o seu tempo em reuniões valer a pena. Torne as reuniões mais assertivas e interessantes, pois todos participantes sabem que serão cobrados quanto a execução.
                                </p>
                            </div>
                            <div className="card">
                                <svg xmlns="http://www.w3.org/2000/svg" height="48" width="48"><path d="M16.85 42Q15.65 42 14.75 41.1Q13.85 40.2 13.85 39V17.65Q13.85 17 14.05 16.5Q14.25 16 14.8 15.45L27.75 2L29.7 3.55Q30 3.8 30.15 4.25Q30.3 4.7 30.3 5.35V5.85L28.05 16.4H43Q44.2 16.4 45.1 17.3Q46 18.2 46 19.4V23.5Q46 24.25 45.925 24.75Q45.85 25.25 45.8 25.4L39.7 39.45Q39.25 40.5 38.225 41.25Q37.2 42 36.05 42ZM16.85 39H36.7Q36.7 39 36.7 39Q36.7 39 36.7 39L43 24.05V19.4Q43 19.4 43 19.4Q43 19.4 43 19.4H24.35L27 6.95L16.85 17.65V39Q16.85 39 16.85 39Q16.85 39 16.85 39ZM2 42H10.85V17.65H2ZM16.85 39Q16.85 39 16.85 39Q16.85 39 16.85 39V17.65V19.4Q16.85 19.4 16.85 19.4Q16.85 19.4 16.85 19.4V24.05V39Q16.85 39 16.85 39Q16.85 39 16.85 39Z" /></svg>
                                <h3>Fácil</h3>
                                <p>
                                    Sistema simples e intuitivo que pode ser operado sem maiores dificuldades por qualquer participante da reunião. Possibilidade de anexar arquivos e fotos.
                                </p>
                            </div>
                            <div className="card">
                                <svg xmlns="http://www.w3.org/2000/svg" height="48" width="48" viewBox="0 0 77.031 100"><path d="M48.958 0H0v100h77.031V29.141L48.958 0zm1.315 13.047 13.223 13.724H50.273V13.047zm18.653 78.854H8.105V8.112h36.087v24.74h24.733v59.049z" /><path d="M16.758 37.448h43.528v4.062H16.758zM16.758 54.271h43.528v4.05H16.758zM16.758 71.094h43.528v4.05H16.758z" /></svg>
                                <h3>Relatório</h3>
                                <p>
                                    Os administradores podem emitir relatórios sobre a utilização do sistema. A fim de gerar estatísticas, o administrador deve informar o período inicial e final e qual o meio de saída dos resultados.
                                </p>
                            </div>
                            <div className="card">
                                <svg xmlns="http://www.w3.org/2000/svg" height="48" width="48"><path d="M27 27Q24.5 27 22.75 25.25Q21 23.5 21 21Q21 18.5 22.75 16.75Q24.5 15 27 15Q29.5 15 31.25 16.75Q33 18.5 33 21Q33 23.5 31.25 25.25Q29.5 27 27 27ZM11 34Q9.75 34 8.875 33.125Q8 32.25 8 31V11Q8 9.75 8.875 8.875Q9.75 8 11 8H43Q44.25 8 45.125 8.875Q46 9.75 46 11V31Q46 32.25 45.125 33.125Q44.25 34 43 34ZM16 31H38Q38 28.9 39.45 27.45Q40.9 26 43 26V16Q40.9 16 39.45 14.55Q38 13.1 38 11H16Q16 13.1 14.55 14.55Q13.1 16 11 16V26Q13.1 26 14.55 27.45Q16 28.9 16 31ZM40 40H5Q3.75 40 2.875 39.125Q2 38.25 2 37V14H5V37Q5 37 5 37Q5 37 5 37H40ZM11 31Q11 31 11 31Q11 31 11 31V11Q11 11 11 11Q11 11 11 11Q11 11 11 11Q11 11 11 11V31Q11 31 11 31Q11 31 11 31Z" /></svg>
                                <h3>Custo</h3>
                                <p>
                                    Plataforma com baixo custo mensal, com possibilidade de convite a terceiros participantes sem custo adicional. Suporte e armazenagem, já incluso nos planos.
                                </p>
                            </div>
            ...
            <section id="about">
                <div className="wrapper">
                    <div className="coluna-a">
                        <header>
                            <h4>SOBRE NÓS</h4>
                            <h2>Entenda quem somos e por que existimo</h2>
                        </header>
                        <div className="content">
                            <p>
                                O Atlasnow é um sistema para a emissão de atas de reunião, seu objetivo é deixar suas reuniões mais rápidas e organizadas. Nosso permite o cadastro das atas de reunião e de seus respectivos participantes.
                            </p>
                        </div>
                    </div>
                    <div className="coluna-b">
                        ...
                        <div className="content">
                            <ul>
                                ...
                                <li>
                                    ...
                                    contato@atlasnow.com
                                </li>
                            </ul>
                            <a
                                className="button"
                                href="https://wa.me/5577991273622"
                                target="_blank"
                            >
                                <svg
                                    width="24"
            ...
            <footer>
                <div className="wrapper">
                    <div className="coluna-a">
                        <a className="logo" onClick={closeMenu} href="#home">
                            <svg
                                width="23.6rem"
                                height="3.1rem"
                                viewBox="0 0 202 64"
